...
with open(f"/home/romain/S01E01.ass", "r") as file:
    data = file.read()

# texts = [
#     "This is a list with my documents I want to translate. I can pass complete documents for translation.",
...
for text in texts:
    r = requests.get(
        url + "/translate?target_lang=" + target_lang + "&text=" + quote(text)
    )
